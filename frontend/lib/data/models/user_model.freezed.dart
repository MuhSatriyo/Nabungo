...
class _$UserModelImpl implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, name: $name, email: $email, avatarUrl: $avatarUrl, xp: $xp, level: $level, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, email, avatarUrl, xp, level, createdAt);
